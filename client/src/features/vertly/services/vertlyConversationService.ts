...
function buildMockResponse(request: VertlyConversationRequest): VertlyConversationResponse {
  ...
  return {
    ...
    suggestions: related.length
      ...
      : [
          ...
          { id: "gen-billing", label: "Plans & billing", prompt: "Explain Convertly plans and billing.", href: ROUTES.billing },
        ],
  }
}
